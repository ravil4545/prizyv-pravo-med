...
const FAQ_ITEMS: FAQItem[] = [
  ...
  },
  {
    ...
    a:
      "От нуля до 200 тысяч рублей — в зависимости от стадии и сложности. Если у вас уже есть документально подтверждённый диагноз из «Расписания болезней», достаточно консультации (9 000 ₽) и одного письменного заключения. Если военкомат игнорирует диагноз — нужно обжалование (от 30 000 ₽). Полное сопровождение под ключ с гарантией возврата гонорара — от 90 000 ₽.",
  ...
  },
  {
    ...
    a:
      "Да — это и есть основная идея. Подписка 990 ₽/мес даёт безлимитный анализ ваших документов, привязку к статьям 565, шаблоны заявлений и дорожную карту дела. Юрист подключается к чату, когда возникает сложная развилка. Для типовых случаев этого хватает — без оплаты полного сопровождения.",
