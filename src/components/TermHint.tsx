...
const TERMS = {
  ...
  chanceB: {
    title: "Шанс категории В",
    text: "Оценка ИИ: насколько загруженный документ подтверждает диагноз по статье Расписания болезней, дающей категорию В («ограниченно годен» — зачисление в запас без службы в мирное время).",
  },
} as const;
