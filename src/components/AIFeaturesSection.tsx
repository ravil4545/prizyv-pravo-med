...
const features: Feature[] = [
  {
    ...
    desc:
      "Загружаете фото справки или PDF — ИИ извлекает диагнозы, привязывает к статьям Постановления №565 и сразу показывает, на какую категорию вы претендуете.",
    mock: <DocumentMock />,
  },
  {
    no: "02",
    ...
    bullet: "Видите весь путь — от повестки до билета",
    desc:
