...
const DEFAULT_TITLE =
  "Военный билет по здоровью законно · юрист 10+ лет · 500+ дел — nepriziv.ru";
const DEFAULT_DESCRIPTION =
  "Юрист Важанина А.Е. — 500+ выигранных дел, освобождение по здоровью, отсрочка, военный билет. Бесплатный разбор за 15 минут. Возврат гонорара при отрицательном решении суда.";
const DEFAULT_KEYWORDS =
  "юрист по призыву, освобождение от армии законно, военный билет по здоровью, отсрочка от армии, обжалование решения призывной комиссии, расписание болезней постановление 565, независимая военно-врачебная экспертиза, категория В военный билет, призывная комиссия суд КАС РФ";
