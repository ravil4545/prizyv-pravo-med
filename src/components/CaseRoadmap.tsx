...
const FUTURE_STAGES: { title: string; hint: string }[] = [
  ...
  {
    title: "Итоговое решение призывной комиссии",
    hint: "Финальный этап — фиксация решения и получение документов на руки (военный билет, справка или решение об отсрочке).",
  },
];
