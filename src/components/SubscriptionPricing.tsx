...
const features = [
  ...
  { label: "Прямой чат с юристом (рабочее время)", included: [true, true] },
  { label: "Приоритетная обработка обращений", included: [false, true] },
  { label: "Письменное заключение юриста раз в квартал", included: [false, true] },
];
...
const faq = [
  ...
  },
  {
    ...
    a: "Безлимитные ИИ-консультации, анализ медицинских документов, доступ к базе статей №565, шаблоны заявлений, дорожная карта дела и прямой чат с юристом. В годовом тарифе дополнительно — приоритетная обработка и письменное заключение раз в квартал.",
  },
  {
    q: "Что НЕ входит?",
    ...
    >
      ...
      <div className="relative container mx-auto px-4 sm:px-6 lg:px-12">
        ...
        <p className="max-w-2xl text-base sm:text-lg text-paper/75 leading-relaxed mb-12 sm:mb-16">
          ...
          ваших документов, дорожная карта дела и прямой чат с юристом — за цену
          обеда в день.
        </p>
