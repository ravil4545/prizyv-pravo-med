...
const faq = [
  ...
  {
    q: "Что будет после 3-дневного пробного периода?",
    a: "Если вы не отмените подписку, на 4-й день спишется выбранный тариф. За день до списания мы пришлём напоминание на email. Отмена доступна в один клик и до, и после списания.",
  },
];
...
const SubscriptionPricing = () => {
  ...
  const startTrial = async () => {
    ...
    if (session?.user) {
      ...
      navigate(`${branding.routePrefix}/auth?mode=signup&next=${encodeURIComponent(dashboard)}`);
    }
  };
    ...
    >
      ...
      <div className="relative container mx-auto px-4 sm:px-6 lg:px-12">
        ...
        <p className="max-w-2xl text-base sm:text-lg text-paper/75 leading-relaxed mb-12 sm:mb-16">
          ...
          ваших документов, дорожная карта дела и календарь дедлайнов.
          Консультация юриста — отдельно, от 9 000 ₽.
        </p>
