...
const credentials = [
  ...
  { label: "Конфиденциальность", value: "По договору, защищена 152-ФЗ" },
];
...
const principles = [
  ...
  },
  {
    ...
    body: "Если вы взяли сопровождение — я веду вас от первой повестки до итогового решения призывной комиссии. Каждое заседание комиссии, каждое заключение — под моим контролем.",
  },
];
    ...
    >
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-12">
        <div className="flex items-center gap-3 mb-3">
          <span className="font-mono text-gold text-xs tracking-[0.3em]">{sectionNumber("about")}</span>
        ...
        <p className="max-w-2xl text-base sm:text-lg text-ink-soft leading-relaxed mb-16">
          За 10+ лет — сотни дел по призывному праву: помощь в освобождении от службы
          по здоровью, обжалование решений призывных комиссий в судах, защита прав
          призывника при незаконных вызовах и действиях военкомата. Беру не каждое
          дело — только те, в которых вижу доказательную перспективу.
        </p>
