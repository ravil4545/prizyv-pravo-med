...
const DEFAULT_BRANDING: Branding = {
  ...
  about:
    "Помогаю призывникам и их семьям законными способами защитить свои права: анализирую медицинские документы, готовлю обоснования по Расписанию болезней, сопровождаю на призывной комиссии и в суде. Работаю на основании договора, соблюдаю конфиденциальность.",
...
const buildBranding = (row: LawyerBrandRow): Branding => ({
  ...
  about:
    ...
    "Помогаю призывникам законными способами защитить свои права: анализ медицинских документов, обоснования по Расписанию болезней, сопровождение на комиссии и в суде.",
