      ...
      <main className="bg-paper text-ink py-12 sm:py-16">
        <div className="container mx-auto px-4 sm:px-6 lg:px-12 max-w-3xl">
          <div className="flex items-center gap-3 mb-3">
            <span className="font-mono text-gold text-xs tracking-[0.3em]">№ 14</span>
          ...
          <div className="prose prose-ink max-w-none space-y-6 text-ink-soft leading-relaxed">
            ...
            <section>
              ...
              <p>
                ...
                дорожная карта дела, чат с юристом в рамках указанных лимитов.
              </p>
            </section>
            ...
            <section>
              ...
              <ul className="list-disc pl-6 space-y-1">
                <li>Месячная подписка — 990 ₽ / 30 дней.</li>
                <li>Годовая подписка — 9 900 ₽ / 365 дней.</li>
                <li>Пробный период — 7 дней без оплаты. По окончании автоматически
