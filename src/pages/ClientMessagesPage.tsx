      ...
      <main className="container mx-auto px-4 py-6 max-w-2xl">
        ...
        <div className="mt-6 p-4 rounded-xl border bg-muted/30 flex items-start gap-3">
          ...
          <p className="text-xs text-muted-foreground">
            Переписка доступна только если юрист добавил вас в свою систему и указал ваш ID аккаунта.
            Ваш ID находится в личном кабинете → блок «Доступ юриста к документам».
          </p>
        </div>
      </main>
      <Footer />
