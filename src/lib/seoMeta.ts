...
export const STATIC_SEO: PageSeo[] = [
  // Две главные точки входа холодного трафика. До этого обе отсутствовали в
  // пре-рендере: краулеры и соцсети видели общий title и canonical на главную.
  {
    path: "/razbor",
    title: "Разбор дела призывника за 3 минуты — бесплатно | nepriziv.ru",
    description:
      "Опишите ситуацию — получите план: под какие статьи Расписания болезней вы попадаете, что собрать по медицинской части и какие заявления подать по юридической. Без регистрации.",
    keywords:
      "разбор дела призывника, что делать с повесткой, какие документы нужны военкомату, план действий призывника, статьи расписания болезней",
    h1: "Разбор вашего дела за 3 минуты",
    bodyText:
      "Четыре вопроса — и вы получите персональный план. Первый блок: под какие статьи Расписания болезней (Постановление №565) подходит ваша ситуация. Второй блок: что нужно по медицинской части — какие исследования и заключения подтверждают диагноз. Третий блок: что нужно по юридической части — какие заявления подать в военкомат и в какой срок, со ссылками на готовые шаблоны. Разбор бесплатный и не требует регистрации. Это предварительная оценка по описанию, а не медицинское или юридическое заключение: категорию годности определяет призывная комиссия по результатам освидетельствования.",
  },
  {
    path: "/ai",
    title: "Спросить ИИ о призыве бесплатно — nepriziv.ru",
    description:
      "Бесплатный ИИ-помощник по призыву: категории годности, Расписание болезней (Пост. №565), отсрочки и освобождение. Ответ за секунды, без регистрации.",
    keywords:
      "ии помощник призывника, возьмут ли в армию с диагнозом, категория годности онлайн, расписание болезней вопрос",
    h1: "Возьмут ли вас в армию? Спросите ИИ",
    bodyText:
      "ИИ-помощник отвечает на вопросы о призыве на основе Расписания болезней (Постановление №565) и экспертной базы знаний практикующего юриста: какая статья подходит под ваш диагноз, какая категория годности возможна, какие документы её подтверждают и как проходит освидетельствование. Первые вопросы бесплатны и не требуют регистрации. ИИ может ошибаться — важные решения проверяйте с юристом.",
  },
  {
    path: "/services",
