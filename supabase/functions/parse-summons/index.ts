...
serve(async (req) => {
  ...
  try {
    ...
    // Используем Lovable AI Gateway — он уже настроен (LOVABLE_API_KEY)
    // и тот же, что в analyze-medical-document. Lovable оплачивает usage,
    // независимо от OpenRouter rate-limit.
