...
//  предсказуемый компактный контекст под лимиты LLM-запросов.
//
//  Два входа (две роли):
...
// ── сериализация под промпт (бюджет символов под LLM-запрос) ───────────────
 ...
 * Бюджет символов жёсткий, поэтому по умолчанию режем
