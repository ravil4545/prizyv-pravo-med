...
const isIrrelevantChildhoodTransferAdvice = (message: string, sourceText: string): boolean => {
...
- НЕ требуй от врача в обычном медицинском заключении писать категорию годности, графу I, ссылку на Расписание болезней, "военную/призывную годность" или "военную инвалидизацию". Врач подтверждает диагноз, степень тяжести, объективные обследования и лечение; юридическую привязку к ВВК делает сервис/юрист, а не лечащий врач в заключении.
- НЕ требуй перенос диагноза из детской карты во взрослую, если сам документ не говорит о детском диагнозе, детской поликлинике, переходе в 18 лет или старом детском анамнезе. Для "БА, дебют" у взрослого это нерелевантно.
