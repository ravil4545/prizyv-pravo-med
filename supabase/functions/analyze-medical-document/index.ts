...
4. Для КАЖДОЙ жалобы или симптома из опросника назначай ВСЕ релевантные обследования.
5. Формат рекомендаций:
   - Анализы: указывай ТОЛЬКО название анализа (например: "Клинический анализ крови", "ТТГ")
   - Обследования: указывай ТОЛЬКО название обследования (например: "МРТ головного мозга", "ЭКГ")
   - Консультации: указывай ТОЛЬКО специальность врача (например: "Консультация невролога", "Консультация кардиолога")
6. Если пациент жалуется на симптомы — назначай все обследования для дифференциальной диагностики.
...
Верни результат СТРОГО в формате JSON:
{
  ...
  "linkedArticles": [
    {
      ...
      "recommendations": ["Название анализа 1", "Название обследования 2", "Консультация специалиста"]
    }
  ],
  ...
  "recommendations": ["Название анализа 1", "Название обследования 2", "Консультация врача-специалиста"],
